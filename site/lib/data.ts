...
export const services = [
  ...
  },
  {
    ...
    titleSingular: "Drone Inspection",
    shortDescription: "Detailed visual inspections for roofs, facades and high-level assets.",
    description:
      "Drone inspections capture hard-to-reach areas safely and efficiently. They help property teams identify defects early and make decisions with clear visual evidence.",
    benefits: [
      "Reduces reliance on scaffolding and access equipment",
      "Provides close-up visual records of defects",
      "Minimises disruption to occupants and operations",
      "Supports maintenance planning and contractor briefings",
      "Improves consistency of repeat inspections"
    ],
    process: [
      "Define inspection objectives and critical areas",
      "Plan flight paths and safe stand-off distances",
      "Capture high-resolution stills and video",
      "Tag defects and areas of concern",
      "Compile findings into an inspection report",
      "Share recommendations and next-step priorities"
    ],
    icon: "Building"
  },
  {
    id: "thermal-drone-imaging",
    slug: "thermal-drone-imaging",
    title: "Thermal Drone Imaging",
    titleSingular: "Thermal Drone Imaging",
    shortDescription: "Thermal aerial capture for heat-loss, moisture and system diagnostics.",
    description:
      "Thermal drone imaging reveals temperature anomalies that are hard to identify visually. It is suited to roof diagnostics, solar panel checks and building envelope assessments.",
    benefits: [
      "Detects hidden issues before they escalate",
      "Supports targeted maintenance and repair planning",
      "Cuts diagnostic time on large or complex roofs",
      "Reduces unnecessary intrusive inspection work",
      "Creates clear thermal evidence for stakeholders"
    ],
    process: [
      "Review objective, conditions and thermal constraints",
      "Schedule flights for optimal thermal contrast windows",
      "Capture calibrated thermal and RGB imagery",
      "Process datasets and align thermal hotspots",
      "Annotate anomalies by asset area",
      "Issue thermal report with recommended actions"
    ],
    icon: "SunMedium"
  },
  {
    ...
    titleSingular: "Aerial Photography",
    shortDescription: "Professional aerial stills and video for marketing and project updates.",
    description:
      "Aerial photography provides polished visuals for estate agents, developers and contractors. It captures property context, scale and progress from angles impossible at ground level.",
    benefits: [
      "Improves listing and marketing presentation",
      "Shows full property and site context",
      "Supports project milestone communications",
      "Provides reusable media for web and social",
      "Delivers consistent image quality across portfolios"
    ],
    process: [
      "Confirm shot list, style and delivery format",
      "Plan safe flight zones and timing for best light",
      "Capture stills and video from key angles",
      "Edit and colour-balance assets",
      "Export web and print-ready versions",
      "Deliver final media set for immediate use"
    ],
    icon: "Camera"
  }
];
...
export const locations = [
  { id: "hertfordshire", name: "Hertfordshire", area: "Hertfordshire", lat: 51.8098, lng: -0.2377, nearbyTowns: ["St Albans", "Watford", "Hemel Hempstead", "Stevenage"] },
  { id: "bedfordshire", name: "Bedfordshire", area: "Bedfordshire", lat: 52.1364, lng: -0.4667, nearbyTowns: ["Bedford", "Luton", "Dunstable", "Leighton Buzzard"] },
  { id: "buckinghamshire", name: "Buckinghamshire", area: "Buckinghamshire", lat: 51.8156, lng: -0.8122, nearbyTowns: ["Aylesbury", "Milton Keynes", "High Wycombe", "Amersham"] },
  { id: "london", name: "London", area: "Greater London", lat: 51.5074, lng: -0.1278, nearbyTowns: ["Westminster", "Camden", "Southwark", "Islington"] },
];
