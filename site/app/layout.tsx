...
export const metadata: Metadata = {
  ...
  description: "Professional drone surveys, drone inspections, thermal drone imaging and aerial photography across London, Hertfordshire, Bedfordshire and Buckinghamshire.",
  icons: {
    icon: "/favicon.ico",
    apple: "/favicon.ico",
  },
